...
struct DiaBLE_LiveActivitiesLiveActivityEntryView : View {
...
struct DiaBLE_LiveActivitiesLiveActivity: Widget {
    let kind: String = "DiaBLE_LiveActivitiesLiveActivity"

    var body: some WidgetConfiguration {
        AppIntentConfiguration(kind: kind, intent: ConfigurationAppIntent.self, provider: Provider()) { entry in
            DiaBLE_LiveActivitiesLiveActivityEntryView(entry: entry)
